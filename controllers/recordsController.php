        ...
        if ($this->user->hasPermission('records_add')) {        	
            ...
            if(isset($_POST['data_er']) && !empty($_POST['data_er'])){
                ...
                if($tipo == '0'){
                    ...
                    $r->add($tipo,$data_er,$hora_er,$colab_ret,null,null,null,null,null,null,$chaves_id,null,null,$iduser);                    
                }
                else if($tipo == '1'){
                    ...
                    $r->add($tipo,$data_er,$hora_er,null,$tipo_vr,$placa_vr,$motorista_vr,$rg,$empresa_vr,null,null,$obs,null,$iduser);
                }
                    ...
                    if(!empty($placa_vr) && !empty($motorista_vr) && !empty($empresa_vr) && !empty($rg)){                    	
                        $r->add($tipo,$data_er,$hora_er,null,null,$placa_vr,$motorista_vr,$rg,$empresa_vr,null,null,$obs,$visitante,$iduser);   
                    }
                    else{
                        $r->add($tipo,$data_er,$hora_er,null,null,null,null,null,null,$veiculos_id,null,$obs,$visitante,$iduser);       
                    }
