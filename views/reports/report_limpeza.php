<h3><center>Relatórios de Limpeza de Maquina</center></h3>

<form id="frmLimpeza">
    <div class="form-row">
        <div class="form-group col-md-4">
            <label>Data Inicial</label>
            <input type="date" name="limpeza_data_inicial" value="<?php echo date("Y-m-d") ?>" class="form-control">    
        </div>
        <div class="form-group col-md-4">
            <label>Data Final</label> 
            <input type="date" name="limpeza_data_final" value="<?php echo date("Y-m-d") ?>" class="form-control">   
        </div>
        <div class="form-group col-md-4">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" name="operador" placeholder="NOME OPERADOR" class="form-control">   
        </div>
    </div>
